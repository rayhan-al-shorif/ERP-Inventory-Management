 ...
 'items' => [
  ...
  [
   ...
   'submenu' => [
    ...
    [
     'title' => 'D. Previous-Order-Up',
     'bullet' => 'dot',
     'page' => 'previous-orders/api/index'
    ],
    [
     'title' => 'E. Short Management',
     'bullet' => 'dot',
     'page' => 'short-management'
    ],
    [
     'title' => 'F. Order Trucker',
     'bullet' => 'dot',
     'page' => 'tracker'
    ],
    [
  ...
  [
   ...
   'submenu' => [
    ...
    [
     'title' => 'C. Fixed Pricing Update',
     'bullet' => 'dot',
     'page' => 'fixed-price'
    ],

    [
     'title' => 'D. Previous Fixed Price',
     'bullet' => 'dot',
     'page' => 'previous-fixing-pricing/index'
    ],

    [
     'title' => 'E. Price Collection',
     'bullet' => 'dot',
     'page' => 'price-collection'
    ],
    [
     'title' => 'F. Customer Type Manual',
     'bullet' => 'dot',
     'page' => 'customer-type-manual'
    ],
    [
     'title' => 'G. Customer-type',
     'bullet' => 'dot',
  ...
  //         /* Withdraw menu */
  //         [
  //             'title' => "F. Salary Management",
  //             'bullet' => 'dot',
  //             'submenu' => [
  //                 [
  //                     'title' => "i. This Month Salary",
  //                     'bullet' => 'dot',
